...
$tour_labels = array(
	'plural_name'=>__('Standard Tours','crb'),
	'singular_name'=>__('Standard Tour','crb'),
);
...
Carbon_Container::factory('custom_fields', __('Tour Layout & Content Options', 'crb'))
	->show_on_post_type(array('tours', 'tour'))
