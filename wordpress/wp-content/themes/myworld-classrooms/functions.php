...
function crb_wp_enqueue_scripts() {
	...
	crb_enqueue_style('theme-googlefonts', 'https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800');
