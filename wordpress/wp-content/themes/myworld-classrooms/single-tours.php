...
<div class="intro intro-teritary <?php echo $classes; ?>">
	...
	<?php if ( $callout_btn_text || $callout_text ): ?>
		<div class="intro-callout">
			<div class="shell">
				<?php if ( $callout_text ): ?>
					<?php echo wpautop($callout_text); ?>
				<?php endif ?>
				
				<?php if ($callout_btn_text && $callout_link ): ?>
					<a href="<?php echo esc_url($callout_link) ?>" class="btn btn-quarinary"><?php echo $callout_btn_text; ?></a>
				<?php endif ?>
			</div><!-- /.shell -->
		</div><!-- /.intro-callout -->
	<?php endif ?>
